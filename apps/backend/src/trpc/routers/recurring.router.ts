...
export const recurringRouter = {
  create: publicProcedure
    ...
    .mutation(({ input, ctx }) =>
      recurringController.create(input, ctx.userId),
    ),
  ...
  update: publicProcedure
    ...
    .mutation(({ input, ctx }) =>
      recurringController.update(input, ctx.userId),
    ),
  ...
  delete: publicProcedure
    ...
    .mutation(({ input, ctx }) =>
      recurringController.delete(input, ctx.userId),
    ),
  ...
  getById: publicProcedure
    ...
    .input(recurringIdSchema)
    .query(({ input, ctx }) =>
      recurringController.getById(input, ctx.userId),
    ),
  ...
  getAll: publicProcedure
    ...
    .query(({ input, ctx }) =>
      recurringController.getAll(input, ctx.userId),
    ),
  ...
  pause: publicProcedure
    ...
    .input(recurringIdSchema)
    .mutation(({ input, ctx }) =>
      recurringController.pause(input, ctx.userId),
    ),
  ...
  resume: publicProcedure
    ...
    .input(recurringIdSchema)
    .mutation(({ input, ctx }) =>
      recurringController.resume(input, ctx.userId),
    ),
};
