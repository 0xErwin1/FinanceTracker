...
import { SessionCSV, type UserCSV } from '../../src/types/csv';
...
export class UserHelper extends Helper {
  ...
  constructor(request: RequestAgent) {
    super(
      request,
  ...
  public async login(body: { email: string; password: string }): Promise<Response> {
